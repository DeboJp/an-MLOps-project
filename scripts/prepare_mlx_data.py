...
def main():
    ...
    mlx_data_dir = os.path.join(project_root, "mlx_data")
    os.makedirs(mlx_data_dir, exist_ok=True)

    # Process splits
    prepare_split(os.path.join(project_root, "data", "train.json"), os.path.join(mlx_data_dir, "train.jsonl"), limit=args.train_limit)
    prepare_split(os.path.join(project_root, "data", "val.json"), os.path.join(mlx_data_dir, "valid.jsonl"), limit=args.val_limit)
    prepare_split(os.path.join(project_root, "data", "test.json"), os.path.join(mlx_data_dir, "test.jsonl"), limit=args.test_limit)
