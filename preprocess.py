...
def clean_dataset(input_path, output_path):
    ...
    and keeps a clean nested 'qa' structure that is 100% compatible with evaluate.py.
    """
    ...
    for example in data:
        ...
        # Keep only the core fields in qa to remain compatible with evaluate.py
        clean_qa = {
