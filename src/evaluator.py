# -*- coding: utf-8 -*-
"""
Decoupled evaluator logic copied from the official FinQA codebase.
Provides program tokenization, symbolic equation equality, and execution validation.
"""
...
def equal_program(program1, program2):
    '''
    symbolic program equality check
    program1: gold
    program2: pred
    '''
    sym_map = {}
...
def evaluate_result(json_in, json_ori):
    """
    Computes overall execution and program accuracy by comparing predictions with dataset splits.
    """
    import json
    ...
    return exe_correct, prog_correct, len(data)
