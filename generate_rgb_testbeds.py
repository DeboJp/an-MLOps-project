...
# Add FinQA evaluate directory to sys.path to import evaluation helper functions
sys.path.append(os.path.join(os.path.dirname(__file__), "FinQA-main", "code", "evaluate"))
from evaluate import program_tokenization, eval_program
